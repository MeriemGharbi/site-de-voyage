...
{  
  ...
  try {
    ...
    function ajouterUser($User)
    {
        $conn = config::getConnexion();
try {
    $requette = $conn->prepare("INSERT INTO tab_user(cin,nom,prenom,d_n,email,phone,pwd,rol,ban,img) VALUES (:cin,:nom,:prenom,:d_n,:email,:phone,:pwd,:rol,:ban,:img)");
    ...
    $requette->bindParam(':img', $Image_User);
    $requette->execute();

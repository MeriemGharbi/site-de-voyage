...
<div class="container">
    ...
    $rated_activities = isset($_SESSION['rated_activities']) ? $_SESSION['rated_activities'] : []; // Initialize rated activities array
    $host = "localhost";
    $username = "root";
    $password = "";
    $dbname = "xplore";
    ...
    try {
        ...
        // Initialize rated activities array
        $rated_activities = isset($_SESSION['rated_activities']) ? $_SESSION['rated_activities'] : [];
        
        foreach ($results as $result) {
            // If activity has been rated, skip it for front end display

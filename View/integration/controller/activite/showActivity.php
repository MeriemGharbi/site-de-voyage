...
<body>
    <style>
         /* Add this CSS to make the table border transparent */
         .table {
    ...
    /* Add this CSS to improve readability of table content */
    .table td, .table th {
        padding: 10px;
        border: none;
        font-size: 16px;
    ...
    /* Add this CSS to improve readability of table headers */
    .table th {
        font-weight: bold;
        background-color: #f3f3f3;
        text-align: left;
    }
    /* Add this CSS to improve readability of table rows */
...
.activity-name {
        ...
        margin-bottom: 5px; /* Add some spacing between activity names */
        font-size: 18px;
    }
.activity-name1 {
        font-weight: bold;

...
#seasonChart {
    margin-right: -900px; /* Add some margin between charts */
    margin-top:30px;
    ...
    $(document).ready(function(){
        ...
        $("#live_search").on('input', function() {
            ...
            if(input != ""){
                ...
                $.ajax({
                    url:"../../controller/activite/showactivity.php", // Change the URL to the PHP file that fetches all results
                    method : "POST",
                    success:function(data){
    ...
    <select onchange="window.location.href=this.value">
        ...
        if (count($categories) > 0) {
            foreach ($categories as $row) {
                ...
                echo "<option value='categoryjoinback.php?category_id=" . $row['id_category'] . "'>" . $row['nom_category'] . "</option>";
            }
        } else {
                ...
                <tbody>
                    ...
                    if (count($result) > 0) {
                        ...
                        foreach ($result as $row) {
                            ...
                            echo "<td class='image' ><a href='../../controller/activite/updateCategory.php?id=" . $row['id_category'] . "'><img src='../../view/backoffice/img/modifier.png' ></a></td>";
                            echo "<td class='image'><a href='../../controller/activite/deleteCategory.php?id=" . $row['id_category'] . "' onclick='return confirm(\"Are you sure you want to delete this category?\");'><img src='../../view/backoffice/img/trash.png'  ></a></td>";
                            echo "</tr>";
                        }
                    } else {
...
$(document).ready(function() {
    ...
    function fetchSortedData(sortOrder) {
        $.ajax({
            url: '../../controller/activite/fetch_sorted_data.php', // Update the URL to the PHP file that fetches sorted data
            type: 'GET',
            data: {

...
require "../controller/vendor/autoload.php";
        ...
        function getQrCode($year,$color,$type,$price,$availb){
            $text = $text = 'Year: ' . $year . '' . "\n" . 
            'Type: ' . $type . "\n" . 
            'Price per Day: ' . $price . "D\n" . 
            'Availability: ' . $availb . "\n" . 
            'Color: ' . $color;
    ...
    while ($car = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        <div class="car">
            <div class="car-details">
                ...
                <p class="car-label">Qr code</p>
                <p class="car-label"><?php echo getQrCode($car['annee'],$car['couleur'],$car['type'],$car['prix_journee'],$car['disponibilite']);?></p>
                

                <a href="addreservationfront.php?id=<?php echo $car['id_voiture']; ?>" class="btn btn-primary">Reservation</a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="img/car1.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="img/car2.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="img/car3.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="img/car2.jpg" alt="">
                        </div>

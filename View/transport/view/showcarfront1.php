...
<body>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="showcarfront.php" class="dropdown-item">Our activities </a>
                            <a href="showcarfront.php" class="dropdown-item">reservation</a>
    ...
    <h1 class="mb-4"><span class="text-primary">Our Cars</span></h1>
</div>
...
?>
    <div class="col">
        <div class="card h-100">
            ...
            <div class="card-body">
                <a href="showcarfront.php" class="btn btn-primary">View more info</a>
            </div>
        </div>
    </div>
<?php
...
<div class="card-body text-center">
    <a href="showcarfront.php" class="btn btn-primary">View all Cars</a>
</div>

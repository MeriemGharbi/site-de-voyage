...
try {
    ...
    if (count($hotels) > 0) {
        ...
        foreach ($hotels as $hotel) {
            ...
            echo 'Prix: ' . $hotel['prixHotel'] . ' dt <img id="editHotelIcon" class="edit-icon" src="https://cdn-icons-png.flaticon.com/512/84/84380.png" alt="Modifier" onclick="showEditForm(\'' . $hotel['nomHotel'] . '\')"><br>';
